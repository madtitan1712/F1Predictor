...
def getcleanedData():
    ...
    try:
        ...
        if pd.isna(maxtime) or pd.isna(max_avg):
            ...
            penalty = 120.0  # Default 2 min Penalty
        else:
        ...
        if "pitstops" in x.columns:
            ...
            x["pitstops"] = 1  # Default is 1
        # Encoding categorical variables like Driver Names, Track Names and Team Names
        ...
        #Saving the encodings as an JSON file
        import json
